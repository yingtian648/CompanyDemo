...
//import com.zlingsmart.demo.mtestapp.location.test.GgaNmeaData;
//import com.zlingsmart.demo.mtestapp.location.test.RmcNmeaData;
//
...
// **/
//public class GnssManagerService extends IGnss.Stub implements FordFnvServiceBase, IHwBinder.DeathRecipient {
...
//    private final RemoteCallbackList<IGnssNmeaDataListener> mNmeaCallbackList = new NmeaRemoteCallbackList<>();
...
//
//    private class NmeaRemoteCallbackList<T extends IInterface> extends RemoteCallbackList<T> {
//        @Override

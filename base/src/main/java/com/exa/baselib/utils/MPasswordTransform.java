 ...
 * 先显示文字后显示星号
 */
public class MPasswordTransform
    ...
    private static class PasswordCharSequence
        ...
        private Object object = new Concrete();
        ...
        public char charAt(int i) {
            if (mSource instanceof Spanned) {
                ...
                int st = sp.getSpanStart(object);
                int en = sp.getSpanEnd(object);
        ...
        public void getChars(int start, int end, char[] dest, int off) {
            ...
            if (mSource instanceof Spanned) {
                ...
                st = sp.getSpanStart(object);
                en = sp.getSpanEnd(object);

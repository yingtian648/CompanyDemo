...
//        // if oemCustomization has GacFont,GacFont will be the default fonts[SystemFonts use it]
//        // DEFAULT         = create((String) null, 0);
//        // DEFAULT_BOLD    = create((String) null, Typeface.BOLD);
//
//        // modify by lsh, 2023.03.24.
//        // GacFont is system normal fonts
//        // If /data/personal_fonts has a font, which will be set as the default font
//        String familyName = "GacFont";
//        if (SystemFonts.getPersonalFamily() != null) {
//            familyName = SystemFonts.getPersonalFamily();
//        }
//        DEFAULT         = create(familyName, 0);
//        DEFAULT_BOLD    = create(familyName, Typeface.BOLD);

...
//    private static String PERSONAL_FAMILY = null;
//
//    private SystemFonts() {
//    }  // Do not instansiate.
//
...
//     */
//    public static @NonNull
//    FontFamily[] getSystemFallback(@Nullable String familyName) {
...
//     */
//    public static @NonNull
//    Map<String, FontFamily[]> getRawSystemFallbackMap() {
...
//     */
//    public static @NonNull
//    FontConfig.Alias[] getAliases() {
//        return sAliases;
//    }
//
//    private static @Nullable
//    ByteBuffer mmap(@NonNull String fullPath) {
...
//
//    private static @Nullable
//    FontFamily createFontFamily(@NonNull String familyName,
...
//        } catch (IOException e) {
//            Log.e(TAG, "readFontCustomization IOException", e);
...
//        // modify by lsh, 2023.03.24.
//        String personalPath = "/data/personal_fonts";
//        final FontCustomizationParser.Result personal =
//                readFontCustomization(personalPath + "/etc/fonts_personal.xml",
//                        personalPath + "/fonts/");
//        if (personal.mAdditionalNamedFamilies.size() > 0
//                && personal.mAdditionalAliases.size() > 0) {
//            PERSONAL_FAMILY = personal.mAdditionalNamedFamilies.get(0).getName();
//            oemCustomization.mAdditionalAliases.addAll(personal.mAdditionalAliases);
//            oemCustomization.mAdditionalNamedFamilies.addAll(personal.mAdditionalNamedFamilies);
//        } else {
//            PERSONAL_FAMILY = null;
//        }
//        Log.w(TAG, "PERSONAL_FAMILY = " + PERSONAL_FAMILY);
//        // modify by lsh, 2023.03.24 end.

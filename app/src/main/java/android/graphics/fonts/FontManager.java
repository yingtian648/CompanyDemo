...
public class FontManager {
    ...
    public String getDefaultFontFamilyName() {
        try {
            return this.mIFontManager.getDefaultFontFamilyName();
        } catch (RemoteException e) {
            Slog.e(TAG, "getDefaultFontFamilyName err:" + e.getMessage());
            return null;
        }
    }

    public void updateFontFamily(String familyName) {
        try {
            this.mIFontManager.updateDefaultFontFamily(familyName);
        } catch (RemoteException e) {
            e.printStackTrace();
            Slog.e(TAG, "getDefaultFontFamilyName err:" + e.getMessage());
        }

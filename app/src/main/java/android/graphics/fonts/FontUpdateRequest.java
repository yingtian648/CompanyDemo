...
//        /* class android.graphics.fonts.FontUpdateRequest.AnonymousClass1 */
//
...
//            /* class android.graphics.fonts.FontUpdateRequest.Font.AnonymousClass1 */
//
//            @Override // android.os.Parcelable.Creator
...
//                return new Font(fontName, new FontStyle(weight, slant), source.readInt(), source.readString8());
//            }
//
//            @Override // android.os.Parcelable.Creator
...
//            /* class android.graphics.fonts.FontUpdateRequest.Family.AnonymousClass1 */
//
//            @Override // android.os.Parcelable.Creator
//            public Family createFromParcel(Parcel source) {
//                return new Family(source.readString8(), source.readParcelableList(new ArrayList(), Font.class.getClassLoader()));
//            }
//
//            @Override // android.os.Parcelable.Creator
...
//                Font.writeToXml(out, fonts.get(i));
...
//                        if (type == 3 && parser.getName().equals(TAG_FAMILY)) {
//                            break;
//                        }
//                    } else {
...
//        this.mFd = (ParcelFileDescriptor) in.readParcelable(ParcelFileDescriptor.class.getClassLoader());
//        this.mSignature = in.readBlob();
//        this.mFontFamily = (Family) in.readParcelable(FontConfig.FontFamily.class.getClassLoader());
//    }
//
//    public int getType() {
//        return this.mType;

...
public class L {
    ...
    private static final boolean DEBUG = Log.isLoggable(TAG, Log.DEBUG) | isLog;
    private static final boolean VERBOSE = Log.isLoggable(TAG, Log.VERBOSE) | isLog;
    ...
    public static void i(String TAG, String msg) {
        L.msg = msg;
        if (isLog) {
            Log.i(L.TAG + TAG_DIVIDER + TAG, msg + SPACE);
        }
    }
    ...
    public static void w(String TAG, String msg) {
        L.msg = msg;
        if (isLog) {
            Log.w(L.TAG + TAG_DIVIDER + TAG, msg + SPACE);
        }
    }
    ...
    public static void e(String TAG, String msg) {
        L.msg = msg;
        if (isLog) {
            Log.e(L.TAG + TAG_DIVIDER + TAG, msg + SPACE);
        }
    }
    ...
    public static void v(String TAG, String msg) {
        L.msg = msg;
        if (VERBOSE) {
            Log.v(L.TAG + TAG_DIVIDER + TAG, msg + SPACE);
        }
    }
    ...
    public static void d(String TAG, String msg) {
        L.msg = msg;
        if (DEBUG) {
            Log.d(L.TAG + TAG_DIVIDER + TAG, msg + SPACE);
        }
    }
    ...
    private static String getThrowableLineNum(Throwable throwable) {
        try {
            ...
            Log.e(TAG, "getThrowableLineNum err!", e);
            return SPACE;
        }
    }
